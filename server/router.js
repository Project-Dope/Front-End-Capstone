...
router.route("/qa/questions/:id/helpful").get(controllers.qa.updateQuestionHelpfulness);
router.route("/qa/answers/:id/helpful").get(controllers.qa.updateAnswerHelpfulness);
